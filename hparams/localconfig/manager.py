...
class LocalConfig(object):
    ...
    def get(self, section, key, raise_not_found=RAISE_ERROR_WHEN_NOT_FOUND):
        """
        ...
        :param raise_not_found: raises a ValueError if a key was not found. if False, returns None instead.
    ...
    def save_config(self, logfile):
        ...
        if 'name' in [l[0] for l in list(self.items('run'))]:
            self.save(logfile)
